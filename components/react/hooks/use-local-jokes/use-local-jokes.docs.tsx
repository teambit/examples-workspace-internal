...
const Example = () => {
    ...
    return (
      <div className={styles.contentWrapper}>
        { error || renderJoke(joke)}>
        <div className={styles.buttonsWrapper}>
          <Button disabled={!!error} onClick={getJoke}>
            {'next joke'}
          </Button>
          <Button variant="secondary" disabled={!!error} onClick={() => removeJoke(joke, getJoke)}>
            {'remove joke'}
          </Button>
        </div>
      </div>
